...
class FbFirestore {
  ...
  Future<dynamic> readCollection({
    ...
    try {
      ...
      // return Future.value(instance.collection(colId).limit(limit).orderBy('created_at', descending: true).get());
      // return Future.value(instance.collection(colId).limit(limit).orderBy('id', descending: true).get());
      // return Future.value(instance.collection(colId).get());
    } catch (e) {
